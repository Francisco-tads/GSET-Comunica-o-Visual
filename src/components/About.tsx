    ...
    <section id="empresa" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 lg:mb-6">Especialistas em Comunicação Visual desde 1995</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
              <div className="flex items-start">
                ...
                <p className="text-gray-700 text-sm sm:text-base">Materiais de alta qualidade</p>
              </div>
              <div className="flex items-start">
                <CheckCircle size={20} className="text-red-600 mt-1 mr-2 flex-shrink-0" />
                <p className="text-gray-700 text-sm sm:text-base">Entrega em todo Brasil</p>
              </div>
              <div className="flex items-start">
                <CheckCircle size={20} className="text-red-600 mt-1 mr-2 flex-shrink-0" />
                <p className="text-gray-700 text-sm sm:text-base">Atendimento personalizado</p>
              </div>
              <div className="flex items-start">
                <CheckCircle size={20} className="text-red-600 mt-1 mr-2 flex-shrink-0" />
                <p className="text-gray-700 text-sm sm:text-base">Qualidade garantida</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 mt-8 lg:mt-0">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform hover:scale-105">
              ...
              <h4 className="text-lg lg:text-xl font-semibold mb-2">Excelência</h4>
              <p className="text-gray-600 text-sm lg:text-base">Qualidade de última geração em todos os projetos</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform hover:scale-105">
              ...
              <h4 className="text-lg lg:text-xl font-semibold mb-2">Experiência</h4>
              <p className="text-gray-600 text-sm lg:text-base">Mais de 10 anos atendendo montadoras de stands</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform hover:scale-105">
              ...
              <h4 className="text-lg lg:text-xl font-semibold mb-2">Especialização</h4>
              <p className="text-gray-600 text-sm lg:text-base">Equipe altamente qualificada e especializada</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center transform transition-transform hover:scale-105">
              ...
              <h4 className="text-lg lg:text-xl font-semibold mb-2">Confiança</h4>
              <p className="text-gray-600 text-sm lg:text-base">Projetos entregues pontualmente e com excelência</p>
            </div>
          </div>
        </div>
      </div>
